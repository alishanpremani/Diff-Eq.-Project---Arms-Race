...
$$\lambda_1 = -\frac{1}{2}d - \frac{1}{2}c + \frac{1}{2}

\section{Case Study ?}
Due to limited time and resources, we define ``weaponry" in this case to only include fighting planes and their associated weapons such as bombs and missiles.
