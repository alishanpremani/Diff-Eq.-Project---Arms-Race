...
\end{cases}$$
where $c \ge 0$ and $d \ge 0$ are constant coefficients of the destruction of old weapons in countries X and Y, respectively.  Our equilibrium solution is (0,0), when both the countries' amounts of weaponry are zero. \\
...
\end{center}
Through a lot of trial-and-error, we find that $a = 10/23$, $b=14/25$, $c=11/25$, and $d = 5/25$ give the best approximation of $x(t)$ and $y(t)$ given the actual data. The graphs of theoretical $x(t)$ and $y(t)$ versus $t$ is below, where the red curve is $x(t)$ for the United States, the blue curve is $y(t)$ for the USSR, and the initial condition is $x(0) = 235$ and $y(0) = 1$:\\
\\
\begin{center}
